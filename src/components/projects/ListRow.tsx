        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div className={`w-14 h-14 rounded-xl ${project.color} flex items-center justify-center text-white shadow-md shrink-0 relative overflow-hidden group-hover:rotate-6 group-hover:scale-110 transition-transform duration-300 z-10`}>
