...
export const ThemeBackground = ({
  ...
  const triforceBg = useMemo(
    () => getTriforceBg(theme.colors.accent),
    [theme.colors.accent],
  );
    ...
    >
      ...
      {theme.pattern === "cross" && (
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(90deg, transparent 48%, currentColor 48%, currentColor 52%, transparent 52%), linear-gradient(transparent 48%, currentColor 48%, currentColor 52%, transparent 52%)`,
