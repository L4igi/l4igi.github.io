...
export const LegalModal = ({ onClose, theme }: LegalModalProps) => {
    ...
    return (
        <div className={`fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/90 sm:bg-black/60 sm:backdrop-blur-sm`}>
            <motion.div
            ...
            >
                ...
                <div className="relative shrink-0 p-6 flex items-center justify-between border-b" style={{ borderColor: theme.colors.secondary, backgroundColor: theme.colors.primary }}>
                    <div className="flex items-center gap-3">
                        <div className="p-2.5 rounded-xl text-white shadow-md" style={{ backgroundColor: theme.colors.accent }}>
                            <Scale size={20} />
                        </div>
                        <h2 className="text-xl font-black tracking-tight" style={{ color: theme.colors.text }}>
                            {t('legal.title')}
                        </h2>
                    </div>
                    <button
                ...
                {isReady && (
                    ...
                    >
                        {/* TABS */}
                        <div className="flex p-2 gap-2 shrink-0" style={{ backgroundColor: theme.colors.primary }}>
                            <button
                                ...
                                style={{
                                    backgroundColor: activeTab === 'IMPRINT' ? theme.colors.accent : 'transparent',
                                    color: activeTab === 'IMPRINT' ? theme.colors.contrastAccent : theme.colors.text
                                }}
                            >
                                {t('legal.imprint')}
                            </button>
                            <button
                                ...
                                style={{
                                    backgroundColor: activeTab === 'PRIVACY' ? theme.colors.accent : 'transparent',
                                    color: activeTab === 'PRIVACY' ? theme.colors.contrastAccent : theme.colors.text
                                }}
                            >
                                {t('legal.privacy')}
                            </button>
                        ...
                        {/* TEXT AREA */}
                        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 sm:p-8" style={{ backgroundColor: theme.colors.cardBg }}>
                            <div
                            ...
                            >
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: activeTab === 'IMPRINT' ? t('legal.imprint_text') : t('legal.privacy_text')
                                    }}
