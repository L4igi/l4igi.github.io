...
export const AboutModal = ({
  ...
  const [activeTab, setActiveTab] = useState<"ID" | "EXP" | "SKILLS" | "LIKES">(
    "ID",
  );
            ...
            >
              {TABS.map((tab) => (
                <button
                  ...
                  className={`relative px-2 py-2 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-colors border ${activeTab === tab.id ? "text-white border-transparent" : "border-transparent hover:bg-black/5"}`}
                  style={{
                    color:
                      activeTab === tab.id
            ...
            {isExpanded && (
              <AnimatePresence mode="wait">
                ...
                {activeTab === "EXP" && (
                  ...
                  >
                    <div
                      className="relative border-l-2 ml-3 space-y-8 py-2"
