...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    details: {
      ...
      de: "**Die Mission:** Wir besaßen ein internes Tool, aber keinen Vertriebsweg. Die Aufgabe war der Bau einer Engine zur Monetarisierung.\n\n**Die Umsetzung:** Wir konzipierten einen dedizierten Microservice, um die Abrechnung vom Hauptprodukt zu entkoppeln. Dieser steuert den gesamten Lebenszyklus (Trial → Active → Cancelled) und verarbeitet Stripe Webhooks für Status-Updates in Echtzeit.\n\n**Impact:** Transformation eines internen Hilfstools in ein kommerzielles SaaS-Produkt.",
    },
